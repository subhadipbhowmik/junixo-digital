...
/* ─── BRAND RECT (for tech stack logos that don't have official icons) ─── */
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            ...
            >
              ...
              <span className="text-orange-500">SEO, Growth</span>
              {" "}and Web Development
            </h1>
            <p
            ...
            >
              We help ambitious brands dominate search rankings, convert traffic at scale, and grow revenue with precision-built digital marketing services, SEO strategies, and high-performance web development.
            </p>
            <ul
            ...
            >
              {["Performance Marketing Campaigns That Drive ROI", "Conversion-Optimised Websites and Web Applications", "Data-Driven SEO Strategies for Long-Term Growth"].map((item) => (
                <li key={item} className="flex items-center gap-3 text-gray-700 font-medium">
                  <span className="text-orange-500 flex-shrink-0"><CheckCircle size={18} /></span>
                  {item}
                </li>
              ))}
            </ul>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-xs">80+ global brands served</p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-400 text-xs">Avg paid media ROAS</p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="relative">
              ...
              <Image
                ...
                alt="Digital Marketing Agency - SEO, Performance Marketing and Web Development"
              ...
              <div className="hidden sm:flex absolute -bottom-5 -left-5 bg-white rounded-2xl shadow-xl px-5 py-4 items-center gap-3 border border-gray-100">
                ...
                <div>
                  <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Organic Traffic Growth</p>
              ...
              <div className="hidden sm:block absolute -top-5 -right-5 bg-white rounded-2xl shadow-xl px-4 py-3 border border-gray-100">
                ...
                <p className="text-[10px] text-gray-400">120+ verified reviews</p>
              </div>
            </div>
...
══════════════════════════════════════════════════════════════ */
const MARQUEE_ITEMS = [
  { label: "Social Media Marketing", icon: <Megaphone size={22} /> },
  { label: "PPC / Google Ads", icon: <Search size={22} /> },
  { label: "Content Marketing", icon: <Code2 size={22} /> },
  { label: "Email Marketing", icon: <Smartphone size={22} /> },
  { label: "Influencer Marketing", icon: <Megaphone size={22} /> },
  { label: "Technical SEO", icon: <Search size={22} /> },
  { label: "Link Building", icon: <Code2 size={22} /> },
  { label: "Web Development", icon: <Code2 size={22} /> },
  { label: "Shopify Development", icon: <Smartphone size={22} /> },
  { label: "iOS & Android Apps", icon: <Smartphone size={22} /> },
  { label: "Conversion Rate Optimisation", icon: <Search size={22} /> },
  { label: "Google Shopping Ads", icon: <Search size={22} /> },
  { label: "Performance Max", icon: <Megaphone size={22} /> },
  { label: "Local SEO", icon: <Search size={22} /> },
  { label: "UI / UX Design", icon: <Palette size={22} /> },
  { label: "WordPress Development", icon: <Code2 size={22} /> },
  { label: "Marketing Analytics", icon: <BarChart2 size={22} /> },
  { label: "App Store Optimisation", icon: <Smartphone size={22} /> },
];
        ...
        {items.map((item, i) => (
          <div key={i} className="flex items-center gap-0 flex-shrink-0">
            <div className="flex items-center gap-2.5 px-7 py-1 group cursor-default">
              <span className="text-orange-400 opacity-70 group-hover:opacity-100 transition-opacity flex-shrink-0">{item.icon}</span>
...
══════════════════════════════════════════════════════════════ */
const services = [
  { icon: <Megaphone size={28} />, title: "Digital Marketing Services", desc: "Full-funnel digital marketing services including Google Ads, paid social, influencer campaigns, email automation, and content marketing - designed to drive measurable traffic, leads, and revenue.", href: "/services/digital-marketing", color: "bg-orange-50 text-orange-500", border: "hover:border-orange-200" },
  { icon: <Search size={28} />, title: "SEO Services", desc: "Enterprise SEO services covering technical audits, on-page optimisation, authoritative link building, and content strategy - engineered to improve search rankings and compound organic growth.", href: "/services/seo", color: "bg-blue-50 text-blue-500", border: "hover:border-blue-200" },
  { icon: <Code2 size={28} />, title: "Web Development Services", desc: "Custom web development services using React, Next.js, and Shopify - delivering fast, conversion-optimised websites and web applications built to perform and scale.", href: "/services/web-development", color: "bg-emerald-50 text-emerald-500", border: "hover:border-emerald-200" },
  { icon: <Smartphone size={28} />, title: "App Development Services", desc: "Mobile app development services for iOS and Android using React Native and Flutter - from MVP prototypes to enterprise-grade applications built for performance and growth.", href: "/services/app-development", color: "bg-purple-50 text-purple-500", border: "hover:border-purple-200" },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center max-w-3xl mx-auto mb-14">
          ...
          <h2 className="text-3xl lg:text-4xl font-black text-gray-900 leading-tight">
            Digital Marketing Services That <span className="text-orange-500">Drive Real Growth</span>
          </h2>
          <p className="text-gray-500 mt-4 text-base leading-relaxed">From performance marketing and technical SEO to custom web development - our full suite of digital services delivers measurable business growth for brands worldwide.</p>
        </FadeIn>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((svc, i) => (
            <FadeIn key={svc.title} delay={i * 100}>
              <Link href={svc.href} className={`group block bg-white border border-gray-200 hover:border-orange-300 rounded-2xl p-7 transition-all duration-300 hover:shadow-xl hover:-translate-y-1`}>
...
/* ══════════════════════════════════════════════════════════════
   4. OUR CORE TECHNOLOGY SERVICES
══════════════════════════════════════════════════════════════ */
const coreTechServices = [
  {
    ...
    image: "https://res.cloudinary.com/junixo/image/upload/v1773339659/home-02-core-services-digital-marketing_wz5ohv.webp",
  ...
  },
  {
    ...
    label: "SEO Services",
    icon: <Search size={20} />,
    image: "https://res.cloudinary.com/junixo/image/upload/v1773340216/home-02-core-services-seo_akkcyv.webp",
    title: "SEO Services",
  ...
  },
  {
    ...
    icon: <Code2 size={20} />,
    image: "https://res.cloudinary.com/junixo/image/upload/v1773340470/home-02-core-services-web-development_pe694p.webp",
  ...
  },
  {
    ...
    image: "https://res.cloudinary.com/junixo/image/upload/v1773340469/home-02-core-services-app-development_awbatf.webp",
    ...
    <section className="py-20 lg:py-28 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-3xl lg:text-4xl font-black text-gray-900 leading-tight">
            Our Core <span className="text-orange-500">Digital Services</span>
          </h2>
          <p className="text-gray-500 mt-4 text-base leading-relaxed max-w-2xl mx-auto">
            From performance marketing and enterprise SEO to custom web and app development - we offer end-to-end digital services built to scale revenue and market share for ambitious brands worldwide.
          </p>
        </FadeIn>
        ...
        {/* ── MOBILE ── */}
        <div className="lg:hidden bg-white border border-gray-100 shadow-sm overflow-hidden">
...
const techStackDomains = [
  ...
  },
  {
    id: "seo", label: "SEO",
    icon: <Search size={18} />,
    title: "SEO Tools and Platforms",
    subtitle: "Industry-leading tools for organic search growth",
    tools: [
  ...
  },
  {
    ...
    subtitle: "Tools we use to craft exceptional digital experiences",
    tools: [
      { name: "Figma", icon: <svg viewBox="0 0 24 24" width="28" height="28"><path d="M8 24c2.208 0 4-1.792 4-4v-4H8c-2.208 0-4 1.792-4 4s1.792 4 4 4z" fill="#0ACF83" /><path d="M4 12c0-2.208 1.792-4 4-4h4v8H8c-2.208 0-4-1.792-4-4z" fill="#A259FF" /><path d="M4 4c0-2.208 1.792-4 4-4h4v8H8C5.792 8 4 6.208 4 4z" fill="#F24E1E" /><path d="M12 0h4c2.208 0 4 1.792 4 4s-1.792 4-4 4h-4V0z" fill="#FF7262" /><path d="M20 12c0 2.208-1.792 4-4 4s-4-1.792-4-4 1.792-4 4-4 4 1.792 4 4z" fill="#1ABCFE" /></svg> },
...
function TechStackSection() {
  ...
  return (
    <section className="py-20 lg:py-28 bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center max-w-3xl mx-auto mb-12">
          <span className="inline-block text-orange-500 text-xs font-bold uppercase tracking-widest mb-3 bg-orange-50 px-4 py-1.5 rounded-full">Tools and Platforms</span>
          <h2 className="text-3xl lg:text-4xl font-black text-gray-900 leading-tight">
          ...
          <p className="text-gray-500 mt-4 text-base max-w-2xl mx-auto">
            We maintain deep expertise across every major platform, framework, and marketing technology your business needs - from modern web development stacks and scalable cloud infrastructure to enterprise marketing tools and analytics platforms.
          </p>
        </FadeIn>
        <FadeIn>
          {/* ── DESKTOP ── */}
            ...
            <div className="w-56 flex-shrink-0 bg-white rounded-2xl border border-gray-100 p-3 self-start">
              ...
              {techStackDomains.map((domain, i) => (
                <button key={domain.id} onClick={() => setActiveDomain(i)}
                  ...
                  {i === activeDomain && <ChevronRight size={14} />}
                </button>
              ))}
            </div>
...
══════════════════════════════════════════════════════════════ */
const features = [
  "Data-Driven Performance Marketing", "Transparent Reporting and Analytics",
  "Conversion-Focused Design and Development", "Experienced Digital Growth Strategists",
  "Fast Execution with Measurable Results", "Long-Term Growth Partnership",
];
          ...
          <FadeIn>
            <div className="relative">
              ...
              <Image src="https://res.cloudinary.com/junixo/image/upload/v1773244613/home-02-why-businesses-choose-junixo_qxviuy.webp"
                alt="Digital Marketing Agency Team - Performance Marketing and SEO Experts" width={600} height={450} className="relative rounded-3xl w-full object-cover shadow-xl" />
              <div className="hidden sm:block absolute -bottom-6 -right-6 bg-white rounded-2xl shadow-xl p-5 border border-gray-100 max-w-[200px]">
                ...
                <p className="text-gray-800 font-bold text-sm leading-snug">"Best digital marketing ROI we have ever seen from an agency."</p>
            ...
            <div className="flex sm:hidden items-center gap-3 mt-4 bg-white rounded-2xl p-4 border border-gray-100 shadow-sm">
              ...
              <p className="text-gray-700 font-semibold text-sm">"Best digital marketing ROI we have ever seen from an agency." - E-commerce Founder</p>
            </div>
          </FadeIn>
          <FadeIn delay={150}>
            ...
            <h2 className="text-3xl lg:text-4xl font-black text-gray-900 leading-tight mb-5">
              Why Businesses Choose Junixo as Their <span className="text-orange-500">Digital Growth Agency</span>
            </h2>
            <p className="text-gray-500 text-base leading-relaxed mb-8">
              We are a performance marketing agency built around measurable outcomes - not deliverables. Our team combines digital strategy, technical SEO, conversion optimisation, and full-stack development to deliver real, trackable growth. Every campaign and every build is engineered to grow revenue.
            </p>
...
══════════════════════════════════════════════════════════════ */
const steps = [
  { num: "01", title: "Discovery and Research", desc: "We conduct in-depth market research and competitive analysis to identify your strongest growth opportunities - building a data-backed digital strategy aligned with your revenue goals." },
  { num: "02", title: "Strategy and Planning", desc: "We build a channel-specific digital marketing and SEO strategy - prioritising the highest-impact activities across paid media, organic search, and web development for maximum ROI." },
  { num: "03", title: "Execution and Development", desc: "Our expert team launches and manages high-performance campaigns, builds conversion-optimised websites, and deploys technical SEO improvements - on time and on brand." },
  { num: "04", title: "Optimisation and Scaling", desc: "Continuous A/B testing, performance optimisation, and data analysis compounds your results month over month - turning initial traction into scalable, long-term digital growth." },
];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <FadeIn delay={150} className="order-1 lg:order-2">
            <div className="relative">
              ...
              <Image src="https://res.cloudinary.com/junixo/image/upload/v1773340900/home-03-growth-process_wtkn1r.webp"
                alt="Digital Marketing and SEO Growth Process" width={600} height={450} className="relative rounded-3xl w-full object-cover shadow-xl" />
            </div>
          </FadeIn>
          <FadeIn className="order-2 lg:order-1">
            ...
            <h2 className="text-3xl lg:text-4xl font-black text-gray-900 leading-tight mb-8">
              Our Proven <span className="text-orange-500">Digital Growth Process</span>
            </h2>
...
══════════════════════════════════════════════════════════════ */
const seoStats = [
  { value: "68%", label: "of all online experiences begin with a search engine query" },
  { value: "0.63%", label: "of Google users click results from page 2 of search rankings" },
  { value: "14.6%", label: "close rate for SEO leads vs 1.7% for outbound marketing" },
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <FadeIn delay={150}>
            <div className="relative">
              ...
              <Image
                src="https://res.cloudinary.com/junixo/image/upload/v1773244613/home-02-why-businesses-choose-junixo_qxviuy.webp"
                alt="SEO Services - Organic Search Traffic and Rankings Growth"
                width={600}
                height={450}
            ...
            <div className="flex sm:hidden mt-4 bg-white rounded-xl p-4 border border-gray-100 shadow-sm items-center gap-3">
              <div className="w-9 h-9 bg-green-100 rounded-xl flex items-center justify-center text-green-500">
                <TrendingUp size={20} />
              </div>
          ...
          {/* CONTENT */}
          <FadeIn>
            <span className="inline-block text-orange-500 text-xs font-bold uppercase tracking-widest mb-3 bg-orange-50 px-4 py-1.5 rounded-full">
              Why SEO Matters
            </span>
            ...
            <p className="text-gray-500 text-base leading-relaxed mb-8">
              Over half of all web traffic originates from organic search. Businesses that invest in professional SEO services dominate their niche, dramatically reduce customer acquisition costs, and build compounding digital value that paid advertising cannot replicate. A strong technical SEO foundation means your brand captures high-intent traffic 24/7 - without paying for every single click.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              {seoStats.map((s) => (
                <div
                  key={s.value}
                  className="bg-white rounded-2xl border border-gray-100 p-5 hover:border-orange-200 hover:shadow-md transition-all duration-200"
                >
...
/* ══════════════════════════════════════════════════════════════
   9. DIGITAL MARKETING RESULTS
══════════════════════════════════════════════════════════════ */
const resultItems = [
  { icon: <TrendingUp size={24} />, title: "ROI-Focused Paid Media Campaigns", desc: "Our Google Ads and Meta Ads campaigns are engineered for maximum return on ad spend. We focus on cost-per-acquisition and revenue growth - consistently delivering 4-9x ROAS for clients across ecommerce, SaaS, and service industries." },
  { icon: <Search size={24} />, title: "Technical SEO That Compounds Over Time", desc: "We resolve the technical SEO issues holding your rankings back - Core Web Vitals, schema markup, crawlability, and site architecture. The result is search engine rankings that grow and compound month after month." },
  { icon: <Monitor size={24} />, title: "Web Development Built to Convert", desc: "Every website we develop starts with conversion strategy - not just aesthetics. Clear CTAs, sub-2-second load times, and A/B-tested layouts ensure visitors become paying customers. Custom development on Next.js, Shopify, and WordPress." },
  { icon: <Users size={24} />, title: "Full-Funnel Social Media Marketing", desc: "From organic content strategy and community management to high-converting paid social campaigns - we manage your complete social media presence to build brand authority, drive engagement, and generate measurable revenue." },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center max-w-3xl mx-auto mb-14">
          ...
          <p className="text-gray-500 mt-4 text-base leading-relaxed">
            We do not chase vanity metrics. Every digital marketing strategy, SEO campaign, and web development project is tied directly to measurable business outcomes - traffic, qualified leads, conversions, and revenue growth.
          </p>
        </FadeIn>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {resultItems.map((item, i) => (
            <FadeIn key={item.title} delay={i * 80}>
              <div className="group bg-white rounded-2xl border border-gray-200 hover:border-orange-300 p-7 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 flex flex-col items-start text-left h-full">
                <div className="flex-shrink-0 w-12 h-12 bg-orange-50 group-hover:bg-orange-500 rounded-2xl flex items-center justify-center text-orange-500 group-hover:text-white transition-all duration-300 mb-4">
                  {item.icon}
                </div>
...
══════════════════════════════════════════════════════════════ */
const industries = [
  { name: "E-commerce and Retail", category: "Digital Commerce", icon: "🛍️", stat: "340% average revenue growth", desc: "Full-funnel ecommerce marketing strategies for Shopify, WooCommerce, and custom stores - from product discovery and SEO to checkout optimisation and paid media campaigns that scale revenue.", impact: "340% revenue", timeline: "6-9 months", href: "/industries/ecommerce" },
  { name: "SaaS and Tech Companies", category: "Software", icon: "💻", stat: "Product-led SEO - 5x organic signups", desc: "SaaS marketing agency services including demand generation, product-led SEO, and growth marketing - turning organic search traffic into free trial signups and paying subscribers at scale.", impact: "5x signups", timeline: "3-6 months", href: "/industries/saas" },
  { name: "Healthcare and Wellness", category: "Health", icon: "🏥", stat: "Compliant campaigns - 2x patient leads", desc: "Healthcare digital marketing strategies that are fully regulation-compliant - building online authority, improving local search visibility, and generating qualified patient leads through ethical campaigns.", impact: "2x leads", timeline: "4-8 months", href: "/industries/healthcare" },
  { name: "Real Estate", category: "Property", icon: "🏢", stat: "Local SEO - 60% more enquiries", desc: "Real estate lead generation through local SEO, Google Ads, and automated lead nurturing systems - purpose-built for property developers, estate agencies, and real estate portals worldwide.", impact: "60% enquiries", timeline: "3-5 months", href: "/industries/real-estate" },
  { name: "Finance and Fintech", category: "Financial Services", icon: "💳", stat: "52% lower cost-per-lead", desc: "Fintech marketing services with full regulatory compliance - combining PPC, content marketing, and technical SEO to convert high-intent financial audiences at significantly lower cost per lead.", impact: "52% lower CPL", timeline: "4-6 months", href: "/industries/finance" },
  { name: "Hospitality and Travel", category: "Tourism", icon: "✈️", stat: "Direct bookings up 38%", desc: "Hospitality digital marketing focused on direct booking growth - cutting OTA dependency through targeted SEO, Google Ads, and conversion-optimised booking experiences that fill rooms profitably.", impact: "38% bookings", timeline: "3-6 months", href: "/industries/hospitality" },
];
    ...
    <section className="py-20 lg:py-28 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center max-w-3xl mx-auto mb-14">
          ...
          <h2 className="text-3xl lg:text-4xl font-black text-gray-900 leading-tight">
            Digital Marketing and SEO Strategies for <span className="text-orange-500">Every Industry</span>
          </h2>
          <p className="text-gray-500 mt-4 text-base leading-relaxed">
            We bring deep sector expertise to every digital marketing engagement - delivering strategies tailored to your industry, target audience behaviour, and competitive landscape.
          </p>
        </FadeIn>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {industries.map((ind, i) => (
            <FadeIn key={ind.name} delay={i * 70}>
              <div className="group bg-white rounded-2xl border border-gray-200 hover:border-orange-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex flex-col h-full overflow-hidden">
                <div className="p-6 flex flex-col flex-1">
                  <div className="flex items-start gap-3 mb-4">
                    <div className="w-11 h-11 bg-gray-100 rounded-xl flex items-center justify-center text-xl flex-shrink-0 group-hover:bg-orange-50 transition-colors duration-300">{ind.icon}</div>
                    <div>
    ...
    <section className="py-20 lg:py-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        <FadeIn className="text-center">
          <span className="inline-block text-orange-500 text-xs font-bold uppercase tracking-widest mb-3 bg-orange-50 px-4 py-1.5 rounded-full">Certified Partners and Platforms</span>
          <h2 className="text-2xl lg:text-3xl font-black text-gray-900 mb-3">
            Official Partnerships and <span className="text-orange-500">Platform Certifications</span>
          </h2>
          <p className="text-gray-500 text-sm max-w-lg mx-auto">We maintain official certifications and enterprise partnerships with the world's leading digital marketing, advertising, and technology platforms.</p>
        </FadeIn>
      </div>
...
══════════════════════════════════════════════════════════════ */
const awards = [
  { image: "https://placehold.co/560x320/fff7ed/f97316?text=Clutch+Top+Agency+2024", badge: "bg-amber-50 text-amber-600 border-amber-200", badgeLabel: "Clutch.co", title: "Top Digital Marketing Agency 2024", desc: "Recognised as a top-rated digital marketing agency for excellence in performance marketing, SEO services, and measurable client growth results.", year: "2024" },
  { image: "https://placehold.co/560x320/eff6ff/3b82f6?text=Google+5-Star+Rating", badge: "bg-blue-50 text-blue-600 border-blue-200", badgeLabel: "Google Reviews", title: "5-Star Rated Digital Agency", desc: "Consistently rated 5 stars by 120+ global clients for outstanding digital marketing results, transparent reporting, and exceptional service quality.", year: "2024" },
  { image: "https://placehold.co/560x320/f0fdf4/22c55e?text=Google+Partner+Badge", badge: "bg-emerald-50 text-emerald-600 border-emerald-200", badgeLabel: "Google", title: "Google Partner Agency", desc: "Official Google Partner - certified across Search Ads, Display Advertising, and Performance Max campaigns with verified client growth benchmarks.", year: "2023" },
  { image: "https://placehold.co/560x320/fdf4ff/a855f7?text=DesignRush+Best+SEO", badge: "bg-purple-50 text-purple-600 border-purple-200", badgeLabel: "DesignRush", title: "Best SEO Agency 2024", desc: "Named among the best SEO agencies globally for delivering measurable organic traffic growth and long-term search engine ranking improvements.", year: "2024" },
  { image: "https://placehold.co/560x320/fff7ed/f97316?text=Shopify+Partner+Badge", badge: "bg-orange-50 text-orange-600 border-orange-200", badgeLabel: "Shopify Partners", title: "Top E-commerce Development Agency", desc: "Certified Shopify Partner with a proven track record delivering high-converting ecommerce websites and digital marketing campaigns for online retailers.", year: "2023" },
  { image: "https://placehold.co/560x320/fef2f2/ef4444?text=Fast+100+Agency+Award", badge: "bg-rose-50 text-rose-600 border-rose-200", badgeLabel: "Agency Spotter", title: "Fast 100 Agency 2023", desc: "Named in the Fast 100 list of the fastest-growing digital marketing agencies worldwide - recognised for rapid growth and client results.", year: "2023" },
];
    ...
    <section className="py-20 lg:py-28 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center max-w-3xl mx-auto mb-14">
          ...
          <h2 className="text-3xl lg:text-4xl font-black text-gray-900 leading-tight">
            Awards and <span className="text-orange-500">Industry Recognition</span>
          </h2>
          <p className="text-gray-500 mt-4 text-base leading-relaxed">Our digital marketing and SEO results speak for themselves - recognised by the industry's most trusted platforms, directories, and certification bodies.</p>
        </FadeIn>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {awards.map((award, i) => (
            <FadeIn key={award.title} delay={i * 80}>
              <div className="group bg-white rounded-3xl border border-gray-200 hover:border-orange-300 overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 flex flex-col">
                ...
                <div className="p-6 flex flex-col flex-1">
                  <div className="flex items-center justify-between mb-3">
                    <span className={`inline-block text-[10px] font-bold uppercase tracking-widest px-3 py-1 rounded-full border ${award.badge}`}>{award.badgeLabel}</span>
...
══════════════════════════════════════════════════════════════ */
const testimonials = [
  { quote: "Junixo transformed our organic search presence. Our website traffic grew by over 400% in under 12 months, and our qualified lead volume tripled. Their SEO strategy and execution is genuinely best-in-class.", name: "Sarah Mitchell", role: "Founder, SaaS Startup", img: "https://placehold.co/56x56/fff7ed/f97316?text=SM", rating: 5, tag: "SEO Services" },
  { quote: "The ROAS on our Google Ads campaigns went from 2.1x to 7.4x within 60 days of working with Junixo. They completely rebuilt our paid media strategy - the revenue growth has been exceptional.", name: "James Okafor", role: "E-commerce Director", img: "https://placehold.co/56x56/eff6ff/3b82f6?text=JO", rating: 5, tag: "PPC and Google Ads" },
  { quote: "Our new website delivered a 2.3x improvement in conversion rate within 45 days of launch. The development quality, load speed, and UX are outstanding. One of the best web development investments we have made.", name: "Priya Sharma", role: "Head of Growth, Tech Company", img: "https://placehold.co/56x56/f0fdf4/22c55e?text=PS", rating: 5, tag: "Web Development" },
  { quote: "Junixo cut our wasted Google Ads spend by 52% in the first 30 days while increasing conversions by 38%. We went from unprofitable campaigns to a clear positive ROI almost immediately.", name: "Daniel Carter", role: "Marketing Lead, D2C Brand", img: "https://placehold.co/56x56/fdf4ff/a855f7?text=DC", rating: 5, tag: "Google Ads" },
  { quote: "After working with three other digital marketing agencies, Junixo is in a completely different league. Their strategic thinking, reporting transparency, and genuine focus on revenue growth set them apart completely.", name: "Emma Walsh", role: "CEO, E-commerce Brand", img: "https://placehold.co/56x56/fef2f2/ef4444?text=EW", rating: 5, tag: "Digital Marketing" },
];
    ...
    <section className="py-20 lg:py-28 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center max-w-xl mx-auto mb-14">
          <span className="inline-block text-orange-500 text-xs font-bold uppercase tracking-widest mb-3 bg-orange-50 px-4 py-1.5 rounded-full">Client Results</span>
          <h2 className="text-3xl lg:text-4xl font-black text-gray-900 leading-tight">
            What Our <span className="text-orange-500">Clients Say</span>
          </h2>
          <p className="text-gray-500 mt-3 text-sm">Trusted by 120+ brands across global markets. Real results, verified reviews.</p>
        </FadeIn>
        <div className="hidden lg:block relative">
          ...
          <button onClick={prev} className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 w-11 h-11 bg-white border border-gray-200 rounded-full shadow-md flex items-center justify-center text-gray-600 hover:border-orange-400 hover:text-orange-500 transition-all cursor-pointer"><ChevronLeft size={20} /></button>
          <button onClick={next} className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 w-11 h-11 bg-white border border-gray-200 rounded-full shadow-md flex items-center justify-center text-gray-600 hover:border-orange-400 hover:text-orange-500 transition-all cursor-pointer"><ChevronRight size={20} /></button>
        </div>
        <div className="lg:hidden">
          <div key={active} className="bg-white rounded-3xl border border-orange-200 shadow-xl p-7" style={{ animation: "fadeUp 0.35s ease" }}>
            ...
            <div className="flex gap-0.5 mb-3">
              {Array.from({ length: testimonials[active].rating }).map((_, i) => <Star key={i} size={13} className="text-amber-400 fill-amber-400" />)}
            </div>
          ...
          <div className="flex items-center justify-center gap-3 mt-6">
            <button onClick={prev} className="w-10 h-10 border border-gray-200 bg-white rounded-full flex items-center justify-center text-gray-500 hover:border-orange-400 hover:text-orange-500 cursor-pointer transition-all"><ChevronLeft size={20} /></button>
            ...
            <button onClick={next} className="w-10 h-10 border border-gray-200 bg-white rounded-full flex items-center justify-center text-gray-500 hover:border-orange-400 hover:text-orange-500 cursor-pointer transition-all"><ChevronRight size={20} /></button>
          </div>
        </div>
    ...
    <section className="py-20 lg:py-28 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
          <div>
            <span className="inline-block text-orange-500 text-xs font-bold uppercase tracking-widest mb-3 bg-orange-50 px-4 py-1.5 rounded-full">Digital Marketing Insights</span>
            <h2 className="text-3xl lg:text-4xl font-black text-gray-900 leading-tight">SEO Strategies and <span className="text-orange-500">Growth Marketing Insights</span></h2>
          </div>
          <Link href="/blog" className="inline-flex items-center gap-2 text-orange-500 font-bold hover:gap-3 transition-all duration-200 flex-shrink-0">View All Articles <ArrowRight size={16} /></Link>
        </FadeIn>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {posts.map((post, i) => (
  ...
  return (
    <div ref={ref} className="relative w-full">
      <button type="button" id={id} onClick={() => setOpen(o => !o)}
        ...
        <span className={`flex-shrink-0 text-gray-400 transition-transform duration-200 ${open ? "rotate-180" : ""}`}><ChevronDown size={16} /></span>
      </button>
      {open && (
        <div className="absolute z-50 mt-1.5 w-full bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
          <div className="flex items-center gap-2 border-b border-gray-100 px-3 py-2.5 bg-gray-50">
            ...
            {query && <button type="button" onClick={() => setQuery("")} className="text-gray-400 hover:text-gray-600 flex-shrink-0"><X size={12} /></button>}
          </div>
          ...
          <div className="bg-orange-50 rounded-3xl border border-orange-100 overflow-hidden shadow-sm">
            <div className="grid lg:grid-cols-2">
              <div className="p-8 sm:p-10 lg:p-14">
                ...
                <p className="text-gray-500 text-base leading-relaxed mb-8">Book your free 30-minute digital strategy consultation. Our experts will audit your current digital presence, identify your highest-value growth opportunities, and outline a clear roadmap to scale traffic, leads, and revenue - no sales pitch, no pressure.</p>
                <div className="space-y-3 mb-8">
                  {["Free comprehensive digital marketing audit included", "Custom SEO and growth strategy for your business", "No long-term contracts or lock-in periods required", "Honest, data-backed expert recommendations"].map((point) => (
              ...
              <div className="bg-white p-8 sm:p-10 lg:p-14 border-t lg:border-t-0 lg:border-l border-orange-100">
                {submitted ? (
                  <div className="h-full min-h-[320px] flex flex-col items-center justify-center text-center py-12">
                    <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4"><CheckCircle size={28} className="text-green-500" /></div>
                    <h3 className="text-gray-900 font-black text-2xl mb-2">You're All Set! 🎉</h3>
                    <p className="text-gray-500 text-sm max-w-xs">Our digital marketing team will reach out within 24 hours to confirm your free strategy consultation and begin your audit.</p>
                  </div>
                ) : (
                  <>
                    <h3 className="text-gray-900 font-black text-xl mb-6">Get Your Free Digital Growth Strategy</h3>
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div>
                        ...
                        <textarea id="message" rows={4} placeholder="Tell us about your business, growth goals, current digital marketing challenges, or anything you'd like us to know…" value={form.message} onChange={set("message")} className={`${inputCls} resize-none ${errors.message ? "border-red-400 focus:border-red-400 focus:ring-red-100" : ""}`} />
...
══════════════════════════════════════════════════════════════ */
const faqs = [
  { q: "How long does it take to see results from SEO services?", a: "SEO services typically produce meaningful ranking improvements within 60-90 days, with compounding organic traffic growth over 6-12 months as domain authority builds. The timeline depends on your starting position, competitive landscape, and the scope of technical SEO work required. We set clear milestone targets from day one and provide transparent monthly reporting so you always know exactly what progress has been made and what to expect next." },
  { q: "What does your digital marketing agency do differently?", a: "We are a performance marketing agency built around measurable revenue outcomes - not just deliverables. Every strategy is tied to specific business metrics: organic traffic, qualified leads, ROAS, and conversions. You get a dedicated team combining digital strategy, technical SEO, paid media, and web development. We do not outsource work, we do not use cookie-cutter playbooks, and we treat every client's growth as our own responsibility." },
  { q: "Do you manage paid advertising alongside SEO services?", a: "Absolutely - and we strongly recommend the integrated approach. Paid Google Ads and Meta Ads campaigns generate immediate, measurable traffic while your SEO strategy builds long-term organic authority. Our performance marketing team manages Google Search Ads, Google Shopping, Performance Max, Meta Ads, TikTok Ads, and LinkedIn Ads with full creative production, audience targeting, budget optimisation, and weekly performance analysis included." },
  { q: "Do you require a long-term contract?", a: "No. All our digital marketing retainer services operate on a month-to-month basis - we earn your continued business by delivering measurable results, not by locking you in. Our project-based work such as website development and app development follows a clear milestone payment structure. The majority of our clients choose to stay with us for 12+ months because they see consistent, compounding growth from our work together." },
  { q: "How do you report on digital marketing performance?", a: "From day one you have access to a live performance dashboard showing real-time data on organic traffic, keyword rankings, conversion rates, ROAS, and revenue attribution. You also receive weekly performance summaries and a monthly in-depth report covering analysis, strategic recommendations, and the next month's priorities. We focus exclusively on the metrics directly tied to your revenue - not vanity numbers or engagement statistics." },
  { q: "Can you work with both startups and established businesses?", a: "Yes - our digital marketing and SEO services are designed to scale with your business. For early-stage startups, we build high-impact, capital-efficient growth strategies and lay the right digital foundation. For established brands, we focus on scaling proven channels, identifying new growth opportunities, and increasing the ROI of existing campaigns. Our onboarding process is tailored specifically to your current situation and growth objectives." },
  { q: "What industries do you have experience in?", a: "We have deep sector expertise across ecommerce and retail, SaaS and technology companies, healthcare and wellness, real estate and property, finance and fintech, and hospitality and travel. Each industry requires a different digital marketing and SEO approach, and we bring genuine sector knowledge to campaign strategy, content creation, and audience targeting - not generic agency templates applied across every client." },
  { q: "What is included in your free digital strategy consultation?", a: "Your free 30-minute consultation includes a high-level audit of your current digital marketing and SEO performance, identification of your top three growth opportunities, a channel-specific recommendation framework aligned to your budget and goals, and an honest assessment of realistic results and timelines. There is no sales pressure and no commitment required - just expert, data-backed advice to help you make the right decision for your business." },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-12">
          ...
          <h2 className="text-3xl lg:text-4xl font-black text-gray-900">
            Digital Marketing and SEO <span className="text-orange-500">Questions Answered</span>
          </h2>
          <p className="text-gray-500 mt-4 text-base max-w-xl mx-auto">
            Everything you need to know about our digital marketing services, SEO process, and how we drive growth.{" "}
            <Link href="/contact" className="text-orange-500 font-semibold hover:underline">Ask us directly.</Link>
          </p>
        </FadeIn>
        <FadeIn delay={80}>
