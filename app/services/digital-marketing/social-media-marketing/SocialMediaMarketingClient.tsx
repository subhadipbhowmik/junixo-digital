    ...
    <section className="relative overflow-hidden bg-white pt-16 pb-24 lg:pt-20 lg:pb-32">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-400 mb-10"
          ...
          <span>/</span>
          <a href="/services/digital-marketing" className="hover:text-orange-500 transition-colors">Digital Marketing</a>
          <span>/</span>
...
const plans = [
  ...
  },
  {
    ...
    cta: "Start Growing",
    ctaStyle: "bg-orange-500 hover:bg-orange-600 text-white shadow-lg shadow-orange-200",
  },
  {
    name: "Scale",
    price: "£3,499",
              ...
              <div className={`relative border-2 ${plan.color} rounded-3xl p-8 bg-white transition-all duration-300 hover:shadow-lg`}>
                {plan.badge && (
                  <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
                    <span className="bg-orange-500 text-white text-xs font-black px-4 py-1.5 rounded-full shadow-md shadow-orange-200 whitespace-nowrap">
                      {plan.badge}
                    </span>
                  </div>
                )}
                ...
                <ul className="space-y-3 mb-8">
                  {plan.features.map((f) => (
                    <li key={f.text} className="flex items-center gap-2.5">
                      <span className={f.included ? "text-orange-500" : "text-gray-300"}>
                        {f.included ? <CheckCircle size={15} /> : <XCircle />}
                      </span>
                ...
                <a href="/get-a-quote"
                  className={`block text-center font-bold px-6 py-3 rounded-full transition-all duration-200 ${plan.ctaStyle}`}>
                  {plan.cta}
                </a>
              </div>
            </FadeIn>
...
══════════════════════════════════════════════════════════════ */
function FinalCTA() {
  const [form, setForm] = useState({ name: "", email: "", company: "", platforms: "" });
          ...
          <div className="bg-white rounded-3xl border border-orange-100 overflow-hidden shadow-sm">
            <div className="grid lg:grid-cols-2 gap-0">
              ...
              <div className="p-10 lg:p-14">
                ...
                {/* Floating social platform icons row */}
                <div className="flex items-center gap-3 p-4 bg-orange-50 rounded-2xl border border-orange-100">
                  <p className="text-gray-500 text-xs font-semibold mr-1">We manage:</p>
                  {[
              ...
              {/* Right form */}
              <div className="bg-orange-50 p-10 lg:p-14 border-l border-orange-100">
                {submitted ? (
                  ...
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      {[
                        ...
                        { key: "company", label: "Company / Brand", type: "text", placeholder: "Your Brand Name" },
                      ].map((field) => (
                        <div key={field.key}>
                          ...
                          <input
                            ...
                            required
                            className="w-full text-sm text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:border-orange-400 transition-colors"
                          />
                        </div>
                      ))}
                      <div>
                        <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Which platforms are you on?</label>
                        <input
                          type="text"
